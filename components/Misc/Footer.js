...
<footer class="p-4 bg-gray-200 sm:p-6 dark:bg-gray-900">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                        <a href="https://tailwindcss.com/" className="hover:underline">Student Learning App</a>
                    </li>
                </ul>
            </div>
            <div>
                <h2 className="mb-6 text-sm md:text-xl font-semibold text-gray-900 uppercase dark:text-white">Follow us</h2>
            ...
            <div>
                <h2 className="mb-6 text-sm md:text-xl font-semibold text-gray-900 uppercase dark:text-white">Legal</h2>
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
    ...
    <div className="sm:flex sm:items-center py-4 sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#home" className="hover:underline">SPAS™</a>. All Rights Reserved.
        </span>
