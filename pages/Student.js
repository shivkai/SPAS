      ...
      <main className="main flex flex-col bg-blue-400 w-full">
        <div className="p-2 items-center relative flex flex-row justify-between bg-gradient-to-r from-sky-300 to-white">
         <div className='flex items-center'>
          ...
          <h1 className='md:text-2xl text-xl  ml-2 font-semibold italic'>Welcome back Shivansh</h1>
          </div>
      
          <div className='hidden lg:block'>
            <button className='p-2 rounded-lg bg-red-300 text-lg'>Log Out</button>
          </div>
        ...
        {(open)?<div className='flex flex-col  bg-blue-400 w-full z-50 '>
            ...
            <button  className='p-2 bg-red-300'>Log Out</button>
        </div>:<div></div>}

        {/* <div className='> */}
          <div className=' bg-gradient-to-b from-sky-200 to-gray-700'>
            {(val == 'course')?<><Courses/> </>:(val=='book')?<><Books/></>:<><Myinfo/></>}
          </div>
        {/* </div> */}
      </main>
    </div>
